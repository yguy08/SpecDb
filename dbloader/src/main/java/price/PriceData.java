...
public class PriceData {
	...
	public PriceData(String currencyPair,String[] singleDayPriceDataStrArr) {
		marketName = currencyPair.replace(".csv", ":POLO");
		
		String dateString = singleDayPriceDataStrArr[0].trim();
