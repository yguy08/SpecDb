...
public class FetchNewMarketRecords {
	
	private long lastUpdateDate;

	public FetchNewMarketRecords(long lastUpdateDate) {
		this.lastUpdateDate = lastUpdateDate;
		if(DbLoader.isConnected()){
			fetchNewRecords();
		}else{
			System.out.println("Db missing new records and in offline mode. Run with network connection to update offline files.");
		}
	}
